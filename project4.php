                ...
                <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="images/project4/kit1.jpg" class="d-block w-100" alt="...">
                        ...
                        <div class="carousel-item">
                            <img src="images/project4/kit2.jpg" class="d-block w-100" width="720" alt="...">
                            <div class="carousel-caption d-none d-md-block">
                            </div>
                        </div>
                        <div class="carousel-item">
                            <img src="images/project4/kit3.jpg" class="d-block w-100" alt="...">
                            <div class="carousel-caption d-none d-md-block">
                            </div>
                        </div>
                    </div>
    ...
    <footer>
        <div class="footerSocialIcons">
            ...
            <div class="footerInformation">
                ...
                <p><a href="project4.php?lang=en"><?php echo $lang['langEn'] ?></a> | <a href="project4.php?lang=ru"><?php echo $lang['langRu'] ?></a></p>
            </div>
    </footer>

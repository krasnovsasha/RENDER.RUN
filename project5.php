                ...
                <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="images/project5/ST%20(1).jpg" class="d-block w-100" alt="...">
                        ...
                        <div class="carousel-item">
                            <img src="images/project5/ST%20(2).jpg" class="d-block w-100" alt="...">
                            <div class="carousel-caption d-none d-md-block">
                            </div>
                        </div>
                        <div class="carousel-item">
                            <img src="images/project5/ST%20(3).jpg" class="d-block w-100" alt="...">
                            <div class="carousel-caption d-none d-md-block">
                            </div>
                        </div>
                        <div class="carousel-item">
                            <img src="images/project5/ST%20(4).jpg" class="d-block w-100" alt="...">
                            <div class="carousel-caption d-none d-md-block">
                            </div>
                        </div>
                    </div>
    ...
    <footer>
        <div class="footerSocialIcons">
            ...
            <div class="footerInformation">
                ...
                <p><a href="project5.php?lang=en"><?php echo $lang['langEn'] ?></a> | <a href="project5.php?lang=ru"><?php echo $lang['langRu'] ?></a></p>
            </div>
    </footer>
